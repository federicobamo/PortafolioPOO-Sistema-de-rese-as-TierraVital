...
/**
 * Capa de lógica del sistema Tierra Vital.
 * Gestiona el registro y consulta de huéspedes.
...
public class Service {
    ...
    public Huesped registrarVisita(String nombre, String nacionalidad, LocalDate fechaNacimiento,
                                   String correoElectronico, String numeroTelefono,
                                   LocalDate fechaEntrada, LocalDate fechaSalida,
                                   Casa casa, Anfitrion anfitrion, double pagoReserva,
                                   int calificacionGeneral, int calificacionLimpieza,
                                   int calificacionSeguridad, int calificacionAnfitrion,
                                   String comentarios) {

        Resena tmpResena = new Resena(calificacionGeneral, calificacionLimpieza,
                calificacionSeguridad, calificacionAnfitrion, comentarios);
        Reserva tmpReserva = new Reserva(fechaEntrada, fechaSalida, casa,
                anfitrion, pagoReserva, tmpResena);
        Huesped tmpHuesped = new Huesped(nombre, nacionalidad, fechaNacimiento,
                correoElectronico, numeroTelefono, tmpReserva);
